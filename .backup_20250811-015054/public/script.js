...
// --- Palette on bottom bar (Build only) ---
...
socket.on('lobby',(st)=>{
  ...
  // Only show lobby (center); board is hidden
  showCenter(lobbyOverlay);
  hideCenter(welcomeOverlay);
...
// --- Init ---
function init(){
  // ensure results modal never shows on load
  hideModal();
  // start at welcome
